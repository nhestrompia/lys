...
The resulting DMG is a drag-to-install image: open it and drag `Lys.app` onto the Applications
folder. The Finder window layout, arrow, and icon positions are embedded in the DMG when it is
created.
