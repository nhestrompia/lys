...
Use Swift API naming conventions, small actors with explicit ownership, and standard Foundation/AppKit/SwiftUI before adding dependencies. Public changes are licensed under MIT and require a Developer Certificate of Origin sign-off in the commit message.
